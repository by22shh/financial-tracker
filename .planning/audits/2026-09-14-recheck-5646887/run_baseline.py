...
snapshot=Path(tempfile.mkdtemp(prefix='fintracker-recheck-'));head, hashes=module.capture(ROOT,snapshot)
...
env.update(FINTRACKER_TEST_DB='fintracker_recheck_'+suffix,FINTRACKER_RESTORE_DB='fintracker_recheck_restore_'+suffix,FINTRACKER_TEST_PG_PORT='55432',FINTRACKER_AI__ENABLED='false',FINTRACKER_ASR__PROVIDER='none',FINTRACKER_PERF='1',PYTHONPATH=str(snapshot/'src'))
